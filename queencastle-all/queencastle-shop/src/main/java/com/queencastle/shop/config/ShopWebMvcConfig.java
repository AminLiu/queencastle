package com.queencastle.shop.config;
...
import com.queencastle.shop.controllers.ShopScanner;


@Configuration
@ComponentScan(basePackageClasses = {ShopScanner.class},
        includeFilters = @Filter(Controller.class), useDefaultFilters = false)
public class ShopWebMvcConfig extends WebMvcConfigurationSupport {
    @Controller
