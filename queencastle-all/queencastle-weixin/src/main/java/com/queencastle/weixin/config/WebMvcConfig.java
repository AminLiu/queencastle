...
import com.queencastle.weixin.controllers.WeiXinScanner;

@Configuration
@ComponentScan(basePackageClasses = {WeiXinScanner.class},
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    static class FaviconController {
        ...
        String favicon() {
            return "forward:/resources/images/favicon.ico.jpg";
        }
    }
    ...
    // spring-thymleaf-ajax-support
    // @Bean
    // public AjaxThymeleafViewResolver ajaxResolver() {
    // AjaxThymeleafViewResolver ajaxResolver = new AjaxThymeleafViewResolver();
    // ajaxResolver.setTemplateEngine(templateEngine());
