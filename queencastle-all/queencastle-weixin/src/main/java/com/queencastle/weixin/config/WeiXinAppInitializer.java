...
import com.queencastle.weixin.filters.WeiXinApiFilter;
import com.queencastle.weixin.filters.WeixinLoginFilter;

public class WeiXinAppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    protected Filter[] getServletFilters() {
        ...
        WeixinLoginFilter weixinLoginFilter = new WeixinLoginFilter();
        WeiXinApiFilter apiFilter = new WeiXinApiFilter();
        return new Filter[] {characterEncodingFilter, etagFilter, weixinLoginFilter, apiFilter};
    }
