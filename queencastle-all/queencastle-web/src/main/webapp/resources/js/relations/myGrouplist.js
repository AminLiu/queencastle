function editUserGroup(){
	 ...
	 row = $('#myGroupTableId').datagrid('getSelected');
		if(row){
		...
		$('#editFrm').form('submit',{
			...
			success : function(data) {
				if (data) {
					...
					$("#myGroupTableId").datagrid("reload");
				} else {
...
function getUserGroupPageData(queryObj){
	$("#myGroupTableId").datagrid({
	   	url:'relations/getMyUserGroupsByParams',
	   	method:'get',
	    loadMsg:'数据加载中....',
	    pagination:true,
		toolbar:"#myGroupToolbar",
	    singleSelect:true,
